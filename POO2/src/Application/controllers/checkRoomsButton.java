...
import Application.model.ChambreTableModel;
	 ...
	 try (BufferedReader br = new BufferedReader(new FileReader("Chambres"))) {
		  ...
		  while ((ligne = br.readLine()) != null) {
		   ...
		   // if (elements.length >= 3) {
		      try {
		        Chambre chambre = new Chambre(Integer.valueOf(elements[0]),Type.valueOf(elements[1]), Double.parseDouble(elements[2]));
	  ...
	  addActionListener(new ActionListener() {
		  public void actionPerformed(ActionEvent e) {
			  ...
			  ChambreTableModel model = new ChambreTableModel(listChambres);
					  ...
					  b1.addActionListener(new ActionListener() {
						  ...
						  public void actionPerformed(ActionEvent e) {
							  ...
							  Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
						        int x = (screenSize.width - frameAjouter.getWidth()) / 2;
						        int y = (screenSize.height - frameAjouter.getHeight()) / 2;

						        // Set the frame location to the center coordinates
						        frameAjouter.setLocation(x, y);
							  ...
							  b4.addActionListener(new ActionListener() {
								  ...
								  public void actionPerformed(ActionEvent e) {
									  ...
									  if(listChambres.size()-1>0) {
									  int lastIndex = listChambres.size()-1;
									  Chambre lastElement = listChambres.get(lastIndex);
									  int num=lastElement.getnumerochambre(); //VERIFIER
									  Chambre c=new Chambre(num+1,selectedType,Double.parseDouble(j4.getText()));
					...
					b2.setBounds(250, 250, 250, 250);
					  ...
					  b2.setBackground(new Color(200, 0, 0));
							  ...
							  b1.addActionListener(new ActionListener() {
								  ...
								  public void actionPerformed(ActionEvent e) {
									  ...
									  frameRecuperer.setSize(400, 150);
									  ...
									  Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
								        int x = (screenSize.width - frameRecuperer.getWidth()) / 2;
								        int y = (screenSize.height - frameRecuperer.getHeight()) / 2;

								        // Set the frame location to the center coordinates
								        frameRecuperer.setLocation(x, y);
											  ...
											  int reponse = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete this room ?", "Confirmation", JOptionPane.YES_NO_OPTION);
										        ...
										        if (reponse == JOptionPane.NO_OPTION) {
										           frameRecuperer.dispose();
										        	...
										        	String a=Fichier.findFirstLineWithPrefix("Chambres",t.getText().toString());
										        	System.out.println(a);
										        	if(a.isBlank()==false&& a.contains("Dates: Vide")==false) {
										        		JOptionPane.showMessageDialog(null, "This room is already reserved !", "Error", JOptionPane.WARNING_MESSAGE);}
										        	else {
										        	if(t.getText().matches("\\d+")) {
									
											  Administrateur.SupprimerChambre(Integer.parseInt(t.getText()));
											  for (int i = listChambres.size() - 1; i >= 0; i--) {
												  Chambre chambre = listChambres.get(i);
					  ...
					  b3.addActionListener(new ActionListener() {
						  ...
						  public void actionPerformed(ActionEvent e) {
							  ...
							  frameModifier.setSize(530, 200);							 
							  frameModifier.setLayout(new GridLayout(3, 1));
							  frameModifier.getContentPane().setBackground(Color.white);
							  
							  Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
						        int x = (screenSize.width - frameModifier.getWidth()) / 2;
						        int y = (screenSize.height - frameModifier.getHeight()) / 2;

						        // Set the frame location to the center coordinates
						        frameModifier.setLocation(x, y);
							  

							  JLabel l1 = new JLabel(" Number of the room:");
							  l1.setFont(new Font("Kannada MN", Font.ROMAN_BASELINE, 20));
							  ...
							  l3.setFont(new Font("Kannada MN", Font.ROMAN_BASELINE, 20));
							  ...
							  b4.addActionListener(new ActionListener() {
								  ...
								  public void actionPerformed(ActionEvent e) {
                                    ...
                                    try { 
                                    	String line=Fichier.findFirstLineWithPrefix("Chambres", j1.getText().toString() );
                  						System.out.println(line);
                  						String[] chambre=line.split(" ");
                  						String oldprice=chambre[2];
                  						System.out.println(oldprice);
                                                                                	
										  int n=Fichier.findLineNumberWithWord("Chambres",line);	
										  System.out.println(n);
										  Fichier.replaceInLine("Chambres",n,oldprice,j3.getText().toString());
										  listChambres.get(n-1).setPrix(Double.parseDouble(j3.getText()));
