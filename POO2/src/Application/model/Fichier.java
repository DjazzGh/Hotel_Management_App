...
public class Fichier {
  ...
  /*  public static void remplacerMotLigneSpecifique(String fichier, int indexLigne, String motARemplacer, String motRemplacement) throws IOException {
    ...
    public static void replaceInLinewithoutnumber(String filePath, String targetLine, String oldWord, String newWord) throws IOException {
    	  // Read the file content into a list of lines
    	  List<String> lines = new ArrayList<>();
    	  try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
    	    String line;
    	  ...
    	  // Replace the word if the line is found
    	  if (index != -1) {
    	    lines.set(index, lines.get(index).replace(oldWord, newWord));
    	  }
    ...
    public static int compterLignesFichier(String nomFichier) throws IOException {
        int compteur = 0;
        try (FileReader lecteurFichier = new FileReader(nomFichier);
             BufferedReader lecteurLigne = new BufferedReader(lecteurFichier)) {
            String ligne;
    ...
    public static void updateFactures() {
    	Fichier.writeToFile("Factures_Clients", "");
